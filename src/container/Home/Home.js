    ...
    Geolocation.getCurrentPosition(
      async position => {
        ...
        await getPopertiesApiCall({
          type: 1,
          data: '',
          latLng: { latitude: currentLatitude, longitude: currentLongitude },
        });
      },
                            ...
                            <View
                                ...
                                <TouchableOpacity
                                  ...
                                  onPress={() => {
                                    setImageIndex(imageIndex + 1);
                                    {
                                      console.log(
                                        'Image test',
                                        item.featured_image_src[imageIndex]
                                          .guid,
                                      );
                                    }
                                  }}>
                              ...
                              <TouchableOpacity
                                ...
                                <Image
                                  ...
                                  source={{
                                    uri: item?.featured_image_src[imageIndex]
                                      ?.guid,
                                  }}
                                />
                              </TouchableOpacity>
                                ...
                                <View
                                  ...
                                  <Animated.View
                                    ...
                                    <Text
                                      ...
                                      You're on your way to locating your dream
                                      home. You can review, rate, comment and
                                      dispose of your Favorited properties by
                                      tapping on your
                                      <TouchableOpacity
                                        style={{
                                          flexDirection: 'row',
                                      ...
                                      <Text
                                        ...
                                        below. I'm also available 24/7 to assist
                                        you with your search. Simply type your
                                        search criteria into our chat or into
                                        the Surf bar at the top of the page and
                                        I will populate all the properties that
                                        match your requested criteria. If you
                                        like that search criteria, feel free to
                                ...
                                <View
                                  ...
                                  <Animated.View
                                    ...
                                    <Text
                                      ...
                                      Congrats on your first surf swipe left! If
                                      you decide to change your mind, you can
                                      find this property in your
                                      <TouchableOpacity
                                        onPress={() => {
